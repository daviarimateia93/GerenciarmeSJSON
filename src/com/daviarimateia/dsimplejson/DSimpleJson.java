package com.daviarimateia.dsimplejson;

import com.daviarimateia.dsimplejson.entity.Person;

public class DSimpleJson
{
	public static final String namespace = "com.daviarimateia.dsimplejson";
